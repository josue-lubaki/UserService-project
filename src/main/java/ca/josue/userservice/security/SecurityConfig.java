package ca.josue.userservice.security;

import ca.josue.userservice.filter.CustomAuthentificationFilter;
import ca.josue.userservice.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        // override the "/login" path becoming UsernamePasswordAuthenticationFilter of CustomAuthentificationFilter
